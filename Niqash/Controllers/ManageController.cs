...
namespace Niqash.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult EditProfile(EditProfileModel editProfileModel)
        {
            ...
            user.AboutMe = editProfileModel.AboutMe;
        ...
        public ActionResult ChangeProfilePic(HttpPostedFileBase profilePicture)
        {
            ...
            currentUser.ProfilePicSrc = "/Uploads/Users/" + currentUserId + ".png";
            _context.SaveChanges();
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return Json(new { changepasswordState = true });
            }
            AddErrors(result);
            return View(model);
        }

        public ActionResult MailConfirmState()
        {
            var user = _context.Users.Find(User.Identity.GetUserId());

            return Json(new { EmailConfirmState = user.EmailConfirmed }, JsonRequestBehavior.AllowGet);
        }
